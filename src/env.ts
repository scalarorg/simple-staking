...
const ProjectENVSchema = z.object({
  ...
  NEXT_PUBLIC_SSL_ENABLED: z.boolean().default(false),

  NEXT_PUBLIC_BITCOIN_WALLET: z.string().default(""),
...
export const ProjectENV = ProjectENVSchema.parse({
  ...
  NEXT_PUBLIC_SSL_ENABLED: process.env.NEXT_PUBLIC_SSL_ENABLED === "true",
