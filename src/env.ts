...
const ProjectENVSchema = z.object({
  ...
  NEXT_PUBLIC_SSL_ENABLED: z.string().optional().default("true"),
  ...
  NEXT_PUBLIC_PROTOCOL_CONTRACT_ADDRESS: z.string().default(""),
});
...
export const ProjectENV = ProjectENVSchema.parse({
  ...
  NEXT_PUBLIC_BITCOIN_NODE_PORT: process.env.NEXT_PUBLIC_BITCOIN_NODE_PORT,
  NEXT_PUBLIC_SSL_ENABLED: process.env.NEXT_PUBLIC_SSL_ENABLED,
  NEXT_PUBLIC_BITCOIN_WALLET: process.env.NEXT_PUBLIC_BITCOIN_WALLET,
  NEXT_PUBLIC_BITCOIN_USER: process.env.NEXT_PUBLIC_BITCOIN_USER,
  NEXT_PUBLIC_BITCOIN_PASSWORD: process.env.NEXT_PUBLIC_BITCOIN_PASSWORD,
